...
class Model:
    def __init__(self, model_identifier: str, output_manager: system.OutputManager, base_directory: str | None = None):
        ...
        self.base_directory = base_directory or system.MODELS_DIRECTORY_PATH

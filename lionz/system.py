...
from lionz.constants import VERSION, ANSI_VIOLET, ANSI_RESET
...
class OutputManager:
    ...
    def display_logo(self):
        ...
        self.console_update(' ')
        result = ANSI_VIOLET + pyfiglet.figlet_format(f" LION {version}", font="smslant").rstrip() + ANSI_RESET
    ...
    def display_citation(self):
        ...
        self.console_update(" ")
        self.console_update(" 10.5281/zenodo.12626789")
        self.console_update(" Copyright 2023, Quantitative Imaging and Medical Physics Team, Medical University of Vienna")
